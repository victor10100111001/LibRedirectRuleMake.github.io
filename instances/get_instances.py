...
def cloudtube():
    ...
    with open('./cloudtube.json') as file:
...
def bibliogram():
    json_object = json.dumps(mightyList, ensure_ascii=False, indent=2)
    with open('./bibliogram.json') as file:
...
def neuters():
    json_object = json.dumps(mightyList, ensure_ascii=False, indent=2)
    with open('neuters.json') as file:
...
def beatbump():
    json_object = json.dumps(mightyList, ensure_ascii=False, indent=2)
    with open('./beatbump.json') as file:
